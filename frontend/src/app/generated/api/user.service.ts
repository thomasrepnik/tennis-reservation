...
export class UserService {
     ...
     */
    public login(body?: Body, observe?: 'body', reportProgress?: boolean): Observable<Token>;
    public login(body?: Body, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Token>>;
    public login(body?: Body, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Token>>;
    public login(body?: Body, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<Token>(`${this.basePath}/user/login`,
            body,
            {
    ...
    /**
     * Meldet den aktuell eingeloggten User ab
     * 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
